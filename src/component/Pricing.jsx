  ...
  return (
    <div id='pricing' className='bg-[#f7f8fc] pt-32'>
      <div className='container mx-auto px-8'>
        ...
        <p className='text-lg mb-12 md:w-2/3 mx-auto'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero, excepturi? Tenetur, iste deleniti. Deserunt amet ipsa fugiat aut rem consequatur sapiente. 
          ...
          quod harum optio repellat aspernatur praesentium, libero natus ut, iste quidem exercitationem ipsam similique ipsum aperiam.</p>
          </div>
