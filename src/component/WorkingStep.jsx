        ...
        className='relative container mx-auto px-4 py-20'>
            <div className='text-white text-center mb-20'> 
              <h2 className='text-4xl font-bold font-secondary mb-4'>How It Works</h2>
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, quos nihil. Est alias ex aut minus deserunt incidunt 
                   adipisci ab laudantium natus, modi, atque dicta quis praesentium saepe molestiae officiis!</p>
            </div>
